...
class Bot(WebBot):
    ...
    def action(self, execution=None):
        ...
        var_clssChrome = Chrome(arg_botWebbot=self, arg_botDesktopbot=self, arg_clssMaestro=var_clssMaestro)
        var_clssExcel = Excel()

        var_clssRelatorios = T2CRelatorios(arg_dictConfig=var_dictConfig)
        var_clssInitAllApplications = T2CInitAllApplications(arg_clssChrome=var_clssChrome, arg_dictConfig=var_dictConfig, arg_botWebbot=self, arg_botDesktopbot=desktop_bot, arg_clssMaestro=var_clssMaestro, arg_clssSqliteQueue=var_clssSqliteQueue)
        ...
        var_clssProcess = T2CProcess(arg_clssExcel=var_clssExcel, arg_clssChrome=var_clssChrome, arg_dictConfig=var_dictConfig, arg_botWebbot=self, arg_botDesktopbot=desktop_bot, arg_clssMaestro=var_clssMaestro)
